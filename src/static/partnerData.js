import juan from '../static/juan-carlos.png';
import luis from '../static/luis-fernando.png';
import lucia from '../static/lucia.png';

const partnerData = [
    {
        name: "Juan Carlos",
        lastName: "Aguirre Laverde",
        bio: "Cuenta con más de 10 años de experiencia en la asesoría jurídica y representación de personas naturales y sociedades en arbitraje comercial y litigios en procesos de responsabilidad civil y seguros, administrativos y ejecutivos.",
        academics: "Abogado de la Universidad Pontificia Bolivariana. Especialista en Responsabilidad Civil y Seguros de la misma Universidad. Especialista en Derecho Comercial de la Universidad del Rosario.",
        image: juan
    },
    {
        name: "Luis Fernando",
